    ...
    <div>
      <div className="relative mb-2">
        <ul className="flex">
          ...
          <li className="ml-2  flex flex-col justify-center center-items">
            <Searchbar className="center-items align-items"/>
          </li>
        </ul>
        <span
          className="absolute bottom-0 h-1 bg-white transition-all duration-300 ease-in-out rounded-xl"
