...
export default function MatchPrediction({ isLoading, prediction }: MatchPredictionProps) {
  if (isLoading) {
    return (
  ...
  return (
    <div className="flex flex-col items-center justify-center h-32 mb-6 p-4 bg-new-color-4 rounded-lg h-32">
